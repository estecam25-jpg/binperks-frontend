/**
 * GET /admin.webmanifest — the BinPerks Admin app manifest.
 *
 * Not requested by this name in practice: middleware.ts rewrites
 * /manifest.webmanifest to here when the host is admin.binperks.com, so
 ...
 *
 * Contents live in lib/pwa-manifest (PWA_APPS.admin).
 */
...
export function GET() {
  return pwaManifestResponse('admin')
}
