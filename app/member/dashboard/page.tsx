    ...
    <div className="min-h-dvh flex flex-col bg-[#F5F5F8]">
      ...
      <main className="flex-1 flex flex-col items-center px-4 py-7 gap-4 max-w-md mx-auto w-full">
        ...
        <div className="w-full flex flex-col items-center text-center gap-1.5">
          ...
          {member.subscriptionStatus === 'vip' ? <span className="text-[10px] font-bold tracking-widest uppercase px-2.5 py-0.5 rounded-full bg-[#4A4B98] text-white">VIP</span> : <TierBadge totalStamps={member.totalStamps} />}
        </div>
