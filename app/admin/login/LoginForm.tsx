...
export default function AdminLoginForm() {
  ...
  useEffect(() => {
    // No client-side session probe here any more. It redirected on ANY session,
    // admin or not, while the dashboard bounces non-admins straight back — a
    // merchant or member who opened this page ping-ponged between the two.
    // page.tsx now decides server-side, before anything paints.
